...
class cardinal_B_spline:public spline
{
public:
	double move;
	double* _a;
	...
	cardinal_B_spline(int n, double* x, double* fx, double a, double b) :spline(n, x, fx, a, b)
	{
		move = 1 - a;
	}
...
class cubic_cardinal_B_spline :public cardinal_B_spline
{
public:
	...
	cubic_cardinal_B_spline(int n, double* x, double* fx, double a, double b, double fa_diff, double fb_diff)
		// fa_diff represents f'[1], fb_diff represents f'[n]
		:cardinal_B_spline(n, x, fx, a, b)
	{
...
class quadratic_cardinal_B_spline :public cardinal_B_spline
{
public:
	...
	quadratic_cardinal_B_spline(int n, double* x, double* fx, double a, double b, double fa, double fb)
